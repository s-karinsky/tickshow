...
export const ModalSpinner = ({dots_color, svg_style}) => {
    return <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" style={svg_style}>
        <circle cx="4" cy="12" r="0" fill={dots_color}>
        ...
        <circle cx="4" cy="12" r="3" fill={dots_color}>
        ...
        <circle cx="12" cy="12" r="3" fill={dots_color}>
        ...
        <circle cx="20" cy="12" r="3" fill={dots_color}>
